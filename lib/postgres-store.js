...
async function migratePostgres() {
  ...
  await db.query(`
    ...
    create unique index if not exists collection_items_users_email_unique_idx
      on collection_items (lower(doc->>'email'))
      where collection = 'users' and coalesce(doc->>'email', '') <> '';
  `);
}
